...
advertise {
  ...
  http = "172.31.33.162" # must be reachable by Nomad CLI clients
  rpc  = "172.31.33.162" # must be reachable by Nomad client nodes
  serf = "172.31.33.162" # must be reachable by Nomad server nodes
}
